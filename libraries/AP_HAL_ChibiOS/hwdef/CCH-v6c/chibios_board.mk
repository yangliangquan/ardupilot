...
# RISCV-V port files
include $(CHIBIOS)/os/common/ports/RISCV-QINGKE/V3F/compilers/GCC/mk/port.mk
...
CSRC += $(HWDEF)/CCH-v6c/stubs.c \
        $(HWDEF)/CCH-v6c/board.c \
        $(HWDEF)/CCH-v6c/usbcfg.c \
        $(HWDEF)/CCH-v6c/usbcfg_common.c \
        $(HWDEF)/CCH-v6c/flash.c \
...
LIBCC_CSRC = $(CRASHCATCHER)/Core/src/CrashCatcher.c \
             $(HWDEF)/CCH-v6c/crashdump.c

# CrashCatcher ARM assembly not available for RISC-V
ifneq ($(findstring riscv,$(MCU)),riscv)
...
# RISC-V specific options (no ARM/THUMB distinction)
AOPT =
TOPT =
...
# End of user defines
##############################################################################
include $(HWDEF)/CCH-v6c/chibios_common.mk
